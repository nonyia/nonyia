...
Based in Atlanta. Currently building [BrunchPass](https://brunchpass.com).
...
A case study in what modern PMs can build hands-on when AI is doing the heavy lifting on code.

---

### 💼 A few highlights from Nike
